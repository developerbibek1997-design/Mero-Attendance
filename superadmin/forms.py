...
class OrgForm(ModelForm):
    class Meta:
        model = Organization
        fields = ('name','expire_on', 'address','member_limit','mutifeature_enable', 'location_based' , 'qr_based', 'auto_checkin', 'serial_key', 'new_serial_key', 'activate')
        ...
        widgets ={
            ...
            'location_based':forms.CheckboxInput(),
            'qr_based':forms.CheckboxInput(),       
            'auto_checkin':forms.CheckboxInput(),
        }